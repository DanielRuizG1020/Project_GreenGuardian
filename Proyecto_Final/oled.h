...
/**brief: Funcion que actualiza el display con las cadenas recibidas
 * 
 * @param line1: Primera línea
 * @param line2: Segunda línea
 * @param line3: Tercera línea
 * @param line4: Cuarta línea
 * 
 * @return void
 */
...
/**brief: Funcion que muestra los datos actuales en el display
 * 
 * @param num_1: Número 1
 * @param num_2: Número 2
 * @param num_3: Número 3
 * @param num_4: Número 4
 * 
 * @return void
 */

void show_current_data(uint8_t num_1, uint8_t num_2, uint8_t num_3) {
    char line1[32];
    char line2[32];
    char line3[32];
    char line4[32];
    ...
    sprintf(line1, "TemA: %u", num_1);
    sprintf(line2, "HumA: %u", num_2);
    sprintf(line3, "HumT: %u", num_3);
   // sprintf(line4, "Luz: %u", num_4);

    // Llamar a la función update_display con las cadenas generadas
    update_display(line1, line2, line3);
}
